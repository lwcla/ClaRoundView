...
internal class ActivatedParse(
    context: Context,
    attr: AttributeSet?
) : ClaDrawableAbs(context, attr, R.styleable.ClaRoundActivatedDrawable) {
    ...
    override fun TypedArray.parse(): ClaRoundViewBuilder {
        ...
        val textTypeface = getInt(R.styleable.ClaRoundActivatedDrawable_cla_activated_textStyle, 0)
